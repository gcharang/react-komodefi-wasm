          ...
          <div className="flex justify-between">
            <div className="flex gap-3">
              ...
              >
                ...
                <div className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-blu-900 p-[2px] px-2 text-xs font-medium text-gray-50 backdrop-blur-3xl">
                  Read Docs
                </div>
              </span>
            </div>
