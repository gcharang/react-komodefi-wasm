...
export const BIP39_WORDLIST = [
  ...
  "may", "maybe", "mayor", "maze", "meadow", "mean", "measure", "meat", "mechanic", "medal",
  ...
  "rush", "sad", "saddle", "sadness", "safe", "sail", "salad", "salmon", "salon", "salt",
...
export const BIP39_WORD_SET = new Set(BIP39_WORDLIST);
export const BIP39_WORD_MAP = new Map(BIP39_WORDLIST.map((word, index) => [word, index]));
export const VALID_MNEMONIC_LENGTHS = [12, 15, 18, 21, 24] as const;
export type ValidMnemonicLength = typeof VALID_MNEMONIC_LENGTHS[number];